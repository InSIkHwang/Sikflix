...
function Tv() {
  ...
  const {
    ...
    refetch: refetchTop,
  } = useQuery<IGetMoviesResult>(["movies", "topRate"], getTopTvs);

  const {
    data: popularData,
    isLoading: popularLoading,
    refetch: refetchPopular,
  } = useQuery<IGetMoviesResult>(["movies", "popular"], getPopularTvs);
  ...
  const bigMovieMatch = useMatch("/tvs/:tvId");
